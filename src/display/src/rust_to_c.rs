use crate::{
    DisplayBackend, DisplayBackendError, DmabufExport, Rect, ResourceFormat,
};
use std::ffi::c_void;
...
pub mod dmabuf_backend {
    ...
    pub extern "C" fn import_dmabuf_fn<I: DisplayBackendDmabuf>(
        instance: *mut c_void,
    ...
    pub extern "C" fn configure_scanout_dmabuf_fn<I: DisplayBackendDmabuf>(
        instance: *mut c_void,
        scanout_id: u32,
        display_width: u32,
        display_height: u32,
    ...
    pub extern "C" fn present_dmabuf_fn<I: DisplayBackendDmabuf>(
        instance: *mut c_void,
        scanout_id: u32,
